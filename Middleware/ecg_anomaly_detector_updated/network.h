...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "ecg_anomaly_detector_no"
...
#define AI_NETWORK_IN_1_HEIGHT      (1000)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (1000)
#define AI_NETWORK_IN_1_SIZE_BYTES  (4000)
