...
set CLASSPATH=%APP_HOME%\lib\mqtt-cli-4.41.0.jar

@rem Execute mqtt
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MQTT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MQTT_EXIT_CONSOLE%" exit 1
exit /b 1
